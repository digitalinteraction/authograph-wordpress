...
Four Corners is a way for photo-journalists and content creators to display a rich visual overlay of metadata onto their web-based images.
...
**WP-Four Corners** simplifies the process of embedding the **Four Corners** library and creating **Four Corners** images in your wordpress site.

the plugin adds an additional 'insert four corners' button to the editor toolbar, which links to the external **Four Corners Metadata Editor**. We overlay the **Four Corners Metadata Editor** directly into the wordpress text editor to enable you to modify the associated metadata of the image, then store this inline with the post / page. **Four Corners Metadata Editor** runs completely client-side and does not retain copies of your images and or metadata, our scripts run entirely in your browser to ensure your images and authorship are secure.
...
1. Upload the plugin files to the `/wp-content/plugins/wp-authograph` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Thats it, you're ready to start using Four Corners images via the wordpress editor toolbar.
